 ...
 */
public class RedissonMessageListenerPostProcessor implements BeanPostProcessor {

    Logger logger = LoggerFactory.getLogger(RedissonMessageListenerPostProcessor.class);
    @Autowired
